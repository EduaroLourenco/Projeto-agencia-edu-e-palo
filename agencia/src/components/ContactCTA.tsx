...
export function ContactCTA() {
  return (
    <section className="relative py-24 sm:py-32">
      <div className="glow-violet animate-drift pointer-events-none absolute left-1/2 top-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-70" />
      ...
      <Reveal className="relative mx-auto max-w-3xl px-5 text-center">
        ...
        <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <MagneticButton
            ...
            target="_blank"
            rel="noreferrer"
            className="group flex items-center gap-2 rounded-full bg-white px-8 py-4 text-sm font-bold text-ink"
          >
