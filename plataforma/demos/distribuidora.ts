...
export const distribuidora: Loja = {
  ...
  paginas: {
    inicio: [
      { id: "b0", tipo: "banner", props: { imagemCelular: urlFoto("hero-distribuidora"), imagemDesktop: urlFoto("hero-distribuidora-largo"), titulo: "Seu estoque, sem sair do balcão", texto: "Mercearia, bebidas e limpeza. Entrega na sua região em 48h.", rotuloBotao: "", linkBotao: "", variante: "sobreposto", altura: "alta" } },
